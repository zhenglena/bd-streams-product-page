...
/**
 * A service that interacts with Amazon's com.amazon.ata.streams.product catalogue. Products can be looked up by their asin.
 */
public class AmazonProductService {
    ...
    /**
     * Creates an in memory Amazon catalog service. Reads com.amazon.ata.streams.product information from a file.
    ...
    /**
     * Retrieve com.amazon.ata.streams.product information from Amazon's catalogue.
     * @param asin - the asin identifier for the com.amazon.ata.streams.product to be retrieved. The asin cannot be null/empty/whitespace.
