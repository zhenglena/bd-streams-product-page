...
public class ProductInformation {
    /**
     * An Amazon specific unique identifier for the com.amazon.ata.streams.product.
     */
    private String asin;

    /**
     * The display name to use when the com.amazon.ata.streams.product appears in search, detail page, etc.
     */
    private String displayName;

    /**
     * A description of the com.amazon.ata.streams.product that can be used if customers want to learn more information.
     */
