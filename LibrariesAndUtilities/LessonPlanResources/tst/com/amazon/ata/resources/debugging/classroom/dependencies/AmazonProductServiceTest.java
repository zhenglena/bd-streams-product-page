...
public class AmazonProductServiceTest {
    ...
    public void getProductByAsin_asinRecognized_productReturned(){
        ...
        // THEN
        // com.amazon.ata.streams.product returned should be non null
        assertNotNull(product, "Expected a recognized asin to return non null com.amazon.ata.streams.product when getProductByAsin" +
            "is called.");
        // com.amazon.ata.streams.product returned should match the requested asin
        assertEquals(recognizedAsin, product.getAsin(), "Expected com.amazon.ata.streams.product returned by getProductByAsin to " +
    ...
    public void getProductByAsin_asinUnrecognized_nullReturned(){
        ...
        // THEN
        // com.amazon.ata.streams.product returned should be null
